...
let mapsWithLikes = [];
const manualSuggestions = ["BEASTMODE BERMUDA", "BEASTMODE KALAHARI","BEASTMODE NEXTERRA","BEASTMODE SOLARA", "AQUA LEGENDS", "1 PLAYER", "2 PLAYER","4 PLAYER","8 PLAYER","INDIA","OTHER SERVERS", "EVOGUNS AND BUNDLE 1V1","HOLI", "THE COLOUR GAME","ZOMBIE HUNT","HONEY DROP","COLOUR DROP","OBJECT ID FINDER"];
